...
export const createUser = async (
  ...
  if (
    ...
    throw new Error(
      "First name must be a valid string between 2 and 25 characters long with no numbers."
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Last name must be a valid string between 2 and 25 characters long with no numbers."
    );
  }
  ...
  if (
    ...
    throw new Error(
      "User name must be a valid string between 4 and 25 characters long."
    );
  }

  if (username === username.toUpperCase()) {
    throw new Error("User name cannot be all uppercase.");
  }
...
export const updateProfile = async (userId, firstName, lastName, userName) => {
  ...
  if (
    ...
    throw new Error(
      "Username name must be a valid string between 4 and 25 characters long."
    );
  }
...
export const getUnapprovedUsers = async () => {
  ...
  const unapprovedUsers = allUsers.filter(
    (user) => !user.isAdminApproved && user.role != "admin"
  );
